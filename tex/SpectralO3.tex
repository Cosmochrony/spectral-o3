...
\begin{document}
  ...
  \title{%
    Projective Dynamics and Mass Hierarchy:\\
    Hierarchical Amplification via Growing Relational Valence%
  }
  ...
  projective resolution; mass hierarchy; relational valence; Cosmochrony framework.
  ...
  \section{The Static LPS No-Go: Precise Statement}
    ...
    \subsection{Setup and notation}
      ...
      \end{equation}
      where $c_{\chi}(n)>0$ is the global projective flux bound and $A_{\min}>0$
      is a fixed scale independent of~$n$.
      Under the isoperimetric closure hypothesis (Hypothesis~2.1
      of~\cite{Beau2026a5}), $c_{\chi}(n)\asymp\hG$, giving
    ...
    \subsection{Synthesis within the O-series architecture}
      ...
      \begin{table}[ht]
        ...
        \begin{tabular}{cll}
          ...
          5 (present paper) &
          What sets the inter-generation mass ratios? &
          Dynamic valence growth, support narrowing \\
          \bottomrule
        \end{tabular}
      \end{table}
